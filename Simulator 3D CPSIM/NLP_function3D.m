function [t_f_opt,Bns_opt,CPU_TIME] = NLP_function3D(ObjectiveWeights,TIME_STEP,N,N_approx_bernstain,recievers_pos_ode,transmitter_pos_hat,d_t,d_safe,v_max)
...
recievers_pos_ode = recievers_pos_ode(:,[1 2 4 5]);
