...
%     end
    ...
    min_sv_ref = 50/(N_neighbours+1);

    sigma_lower_err = min(0,sigma_lower-min_sv_ref)*(sigma_lower-min_sv_ref);

    Wx = (1/(2*d_safe))^2;
    Wdx = (1/(v_max/2))^2;
    Wu = (1/9.81)^2;
    We = (1/(N_neighbours*d_safe))^2;
    Wxnid = (1/d_safe)^2;
%     Wxnid = 0;
%     Wxnid = (10)^2;
    Wsigma = (1/1e-02)^2;
...
%         Wsigma * sigma_lower; % 1.1667 W_sigma per drone
    ...
    J = Wx * sum((X1_ref-X1).^2) + ...
        ...
        We * e.^2 + ...
        Wxnid * (XID + XNID) + ...
        Wsigma * sigma_lower_err; % 1.1667 W_sigma per drone
